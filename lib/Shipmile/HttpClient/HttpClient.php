...
namespace Shipmile\HttpClient;

use Guzzle\Http\Client as GuzzleClient;
use Guzzle\Http\ClientInterface;
use Guzzle\Http\Message\RequestInterface;

use Shipmile\HttpClient\AuthHandler;
use Shipmile\HttpClient\ErrorHandler;
use Shipmile\HttpClient\RequestHandler;
use Shipmile\HttpClient\Response;
use Shipmile\HttpClient\ResponseHandler;
